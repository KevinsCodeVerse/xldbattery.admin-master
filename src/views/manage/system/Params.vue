<template>
    <div id="sys_params">
        ...
        <main-content>
            <el-table :data="list" stripe style="width: 100%" v-loading="load">
                ...
                <el-table-column prop="value" label="参数值" align="center">
                    <template slot-scope="scope">
                         <el-image v-if="scope.row.id==6" style="width: 100px; height: 100px" :src="scope.row.value" :preview-src-list="[scope.row.value]">
                        </el-image>
                ...
                <el-table-column label="操作" align="center" fixed="right" min-width="100px">
                    <template slot-scope="scope">
                        <el-button type="primary" plain size="small" @click="update(scope.row)">修改</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
            ...
            <el-dialog title="上传图片" :visible.sync="logoVisible" @close="logoClear" width="500px">
                <el-form ref="form"  label-width="90px" :model="logoData">
                    <el-form-item label="图片">
                        <el-upload class="qqImg" action="#" accept="image/*" :auto-upload="false" :show-file-list="false"
            ...
            <el-dialog :close-on-click-modal="false" title="编辑" :visible.sync="editVisible" @close="editClear" width="800px">
                <el-form ref="form"  label-width="90px" :model="editData">
                   <el-form-item label="内容:" prop="content">
                        <WangEditor :isClear="true" :value.sync="editData.value" uploadImgServer="system/sysParams/admin/uploadImage" ref="wangEditor"></WangEditor>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
